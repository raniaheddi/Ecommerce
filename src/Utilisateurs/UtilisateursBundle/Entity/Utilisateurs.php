...
class Utilisateurs extends BaseUser
{
     ...
     * @ORM\OneToOne(targetEntity="Ecommerce\EcommerceBundle\Entity\Favoris",cascade={"persist", "remove"})
     * @ORM\JoinColumns({
     ...
     */
     ...
     /**
     * @var \Panier
     * @ORM\OneToOne(targetEntity="Ecommerce\EcommerceBundle\Entity\Panier",cascade={"persist", "remove"})
     * @ORM\JoinColumns({
     ...
     * Set favoris
     *
     * @param \Ecommerce\EcommerceBundle\Entity\Favoris $favoris
     * @return User
     */
    public function setFavoris(\Ecommerce\EcommerceBundle\Entity\Favoris $favoris = null)
    {
     ...
     * Get favoris
     *
     * @return \Ecommerce\EcommerceBundle\Entity\Favoris
     */
