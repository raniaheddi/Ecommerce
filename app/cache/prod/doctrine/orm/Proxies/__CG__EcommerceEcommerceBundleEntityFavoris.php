 ...
 */
class Favoris extends \Ecommerce\EcommerceBundle\Entity\Favoris implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Favoris' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Favoris' . "\0" . 'produits'];
        }
    ...
    public function setProduits(\Ecommerce\EcommerceBundle\Entity\Produits $produit = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProduits', [$produit]);

        return parent::setProduits($produit);
    }
