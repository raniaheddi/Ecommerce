 ...
 */
class Commentaire extends \Ecommerce\EcommerceBundle\Entity\Commentaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commentaire' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commentaire' . "\0" . 'corps', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commentaire' . "\0" . 'datecom', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commentaire' . "\0" . 'produit', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commentaire' . "\0" . 'user'];
        }
