 ...
 */
class Commentairesujet extends \Ecommerce\EcommerceBundle\Entity\Commentairesujet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commentairesujet' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commentairesujet' . "\0" . 'commentaire', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commentairesujet' . "\0" . 'datecom', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commentairesujet' . "\0" . 'sujet', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commentairesujet' . "\0" . 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Commentairesujet $proxy) {
    ...
    public function setDatecom($datecom)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDatecom', [$datecom]);

        return parent::setDatecom($datecom);
    }
    ...
    public function getDatecom()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDatecom', []);

        return parent::getDatecom();
    }
