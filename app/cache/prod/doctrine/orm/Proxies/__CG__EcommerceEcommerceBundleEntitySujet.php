 ...
 */
class Sujet extends \Ecommerce\EcommerceBundle\Entity\Sujet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Sujet' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Sujet' . "\0" . 'titre', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Sujet' . "\0" . 'sujet', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Sujet' . "\0" . 'dateAjout', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Sujet' . "\0" . 'img', 'file', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Sujet' . "\0" . 'user'];
        }
