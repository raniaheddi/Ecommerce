 ...
 */
class Contact extends \Ecommerce\EcommerceBundle\Entity\Contact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Contact' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Contact' . "\0" . 'nom', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Contact' . "\0" . 'email', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Contact' . "\0" . 'sujet', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Contact' . "\0" . 'message'];
        }
