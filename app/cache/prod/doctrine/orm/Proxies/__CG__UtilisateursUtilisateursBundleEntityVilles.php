...
class Villes extends \Utilisateurs\UtilisateursBundle\Entity\Villes implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeId', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeDepartement', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeSlug', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeNom', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeNomSimple', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeNomReel', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeNomSoundex', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeNomMetaphone', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeCodePostal', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeCommune', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeCodeCommune', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeArrondissement', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeCanton', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeAmdi', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villePopulation2010', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villePopulation1999', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villePopulation2012', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeDensite2010', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeSurface', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeLongitudeDeg', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeLatitudeDeg', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeLongitudeGrd', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeLatitudeGrd', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeLongitudeDms', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeLatitudeDms', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeZmin', '' . "\0" . 'Utilisateurs\\UtilisateursBundle\\Entity\\Villes' . "\0" . 'villeZmax'];
        }
    ...
    public function getVilleId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVilleId', []);
